...
import { deleteDailyHouse } from './../../features/dailyHouse/dailyHouseSlice';
import Swal from 'sweetalert2';

function EachProductCardDaily({ house, availablity, socket, newHouseListHandeler }) {
  ...
  const handleDeleteHouse = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        dispatch(deleteDailyHouse(house._id))
